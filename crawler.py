...
subprocess.run(["streamlit", "run", "app.py", "--server.baseUrlPath=/team2s25", "--server.port=2502", "--theme.backgroundColor=#0065BD", "--theme.primaryColor=#808284", "--theme.secondaryBackgroundColor=#808284", "--theme.textColor=#FFFFFF", "--browser.gatherUsageStats=false"])